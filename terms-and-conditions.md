...
{#2} Las presentes condiciones generales tienen por objeto la regulación de la relación jurídica del usuario del modelo de negocio denominado <<RACHA>> (también AM RACHA), el cual tiene por objeto hacer accesible a usuarios su participación en determinados proyectos relacionados con las denominadas finanzas descentralizadas (DEFI, en lo sucesivo), entre las que se encuentra la “POOL ALL-IN”, sin perjuicio de la implementación futura de nuevos productos y/o servicios, los cuales podrían tener un régimen y tratamiento jurídico propios, mediante sus términos y condiciones específicos, todo ello bajo los postulados de un plan de compensación basado en el marketing multinivel como forma de ejecución de nuestro modelo de negocio.
